        ...
        <div class="col-md-3 left_col menu_fixed">
          <div class="left_col scroll-view">
                ...
                <ul class="nav side-menu">
                  <li><a><i class="fa fa-home"></i> APP管理 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu">
                      <li><a href="${pageContext.request.contextPath }/backends/applist.html">APP审核</a></li>
            ...
            <div class="sidebar-footer hidden-small">
              ...
              <a data-toggle="tooltip" data-placement="top" title="Logout" href="${pageContext.request.contextPath }/back/loginOut">
