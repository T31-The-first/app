...
<div class="row">
	<div class="col-md-12">
		<div class="x_panel">
			...
			<div class="x_content">
				<form method="post" action="/developer/appinfo/applist.html">
	...
	<div class="x_panel">
		<div class="x_content">
			...
			<div id="datatable-responsive_wrapper"
				...
				<div class="row">
					<div class="col-sm-12">
					<a href="${pageContext.request.contextPath}/developer/appinfo/add.html" class="btn btn-success btn-sm">新增APP基础信息</a>
						<table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap dataTable no-footer dtr-inline collapsed"
							...
							<tbody>
								<c:forEach var="appInfo" items="${appListPage.dataList }" varStatus="status">
				...
				<div class="row">
					<div class="col-sm-5">
						<div class="dataTables_info" id="datatable-responsive_info"
							role="status" aria-live="polite">共${appListPage.totalCount }条记录
							${appListPage.pageIndex }/${appListPage.totalPage }页</div>
					</div>
					<div class="col-sm-7">
						<div class="dataTables_paginate paging_simple_numbers"
							id="datatable-responsive_paginate">
							<ul class="pagination">
								<c:if test="${appListPage.pageIndex > 1}">
									...
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appListPage.pageIndex-1});"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">上一页</a>
									</li>
								</c:if>
								<c:if test="${appListPage.pageIndex < appListPage.totalPage }">
									<li class="paginate_button "><a
										href="javascript:page_nav(document.forms[0],${appListPage.pageIndex+1 });"
										aria-controls="datatable-responsive" data-dt-idx="1"
										tabindex="0">下一页</a>
									...
									<li class="paginate_button next"><a
										href="javascript:page_nav(document.forms[0],${appListPage.totalPage });"
